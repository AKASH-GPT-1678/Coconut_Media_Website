...
const page = () => {
    ...
    return (
        <div>
            <div className='w-full h-[400px]' style={{ backgroundImage: "url('https://meat-bucket-2025.s3.ap-south-1.amazonaws.com/cocoasset/body-brain.jpg')", backgroundSize: "cover" }} >
