...
const page = () => {
    ...
    return (
        <div>
            <div className='w-full h-[400px]' style={{ backgroundImage: "url('https://res.cloudinary.com/dffepahvl/image/upload/v1753692201/bgug3m7runy2wh3cpuoh.jpg')", backgroundSize: "cover" }} >
