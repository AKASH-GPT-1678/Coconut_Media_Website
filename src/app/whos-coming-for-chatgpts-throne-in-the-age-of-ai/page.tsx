...
import Blog from '../Components/AIBlog';
...
const page = () => {
  ...
  return (
    <div>
      <div className='w-full h-[400px]' style={{ backgroundImage: "url('https://res.cloudinary.com/dffepahvl/image/upload/v1753692201/fbp1mriss5bshnjbddxm.jpg')", backgroundSize: "cover" }} >
